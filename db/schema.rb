...
ActiveRecord::Schema[7.1].define(version: 2024_05_29_181147) do
  ...
  create_table "group_reservations", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["inn_id"], name: "index_group_reservations_on_inn_id"
  end
  ...
  add_foreign_key "group_reservations", "inns"
